...
connection = pymysql.connect(host='localhost', user='root', password='Saurabh1@')
...
st.set_page_config(
    page_title="Career Craft Scanner",
    page_icon='./Logo/SRA_Logo.ico',
)


def run():
    st.title("Career Craft Scanner")
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'saurabh' and ad_password == 'saurabh123':
                st.success("Welcome Saurabh")
                # Display Data
